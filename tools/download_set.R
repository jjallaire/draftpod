...
download_cards <- function(cards,
  ...
  cards <- lapply(cards, function(card) {
    ...
    # get id
    if (set == "znr" || set == "afr" || set == "mid" || set == "vow" || set == "neo" || set == "dmu" || set == "one" || set == "bro" || set == "mom" || set == "woe") {
    ...
    if ((set == "khm" || set == "stx" || set == "mid" || set == "vow" || set == "neo" || set == "snc" || set == "mom" || set == "woe") && length(image_uris) == 2) {
