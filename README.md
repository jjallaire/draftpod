...
Draftpod is open-source software. If you interested in helping to improve Draftpod we welcome your contributions, please send us a [pull request](https://github.com/jjallaire/draftpod/pulls)!
...
The Draftpod website (https://draftpod.org) is unofficial Fan Content permitted under the [Wizards Fan Content Policy](https://company.wizards.com/fancontentpolicy). The literal and graphical information presented on the site about Magic: The Gathering, including card images, is copyright © Wizards of the Coast, LLC, a subsidiary of Hasbro, Inc. The website is not produced by, endorsed by, supported by, or affiliated with Wizards of the Coast.
